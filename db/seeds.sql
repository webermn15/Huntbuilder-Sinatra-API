...
INSERT INTO hunts (title, description, user_id, hints, victory_code, lat, long, zoom) VALUES ('chinatown hunt', 'this is a big old description of the chinatown hunt', 1, '{"hintone", "hinttwo", "hintthree"}', 'h83ns0', 41.850691, -87.634049, 12);
INSERT INTO hunts (title, description, user_id, hints, victory_code, lat, long, zoom) VALUES ('the loop hunt', 'this time, im writing a fatass string for the loop hunt description', 3, '{"hintone", "hinttwo", "hintthree"}', 'h83ns0', 41.850691, -87.634049, 12);
INSERT INTO hunts (title, description, user_id, hints, victory_code, lat, long, zoom) VALUES ('montreal hunt', 'montreal hunt also gets a description, though its short', 1, '{"hintone", "hinttwo", "hintthree"}', 'h83ns0', 41.850691, -87.634049, 12);
